(function jvxPixelWrapper(){
    ...
    var isDebug = false;
    var existingData = ["13090903"];
    var existingGroups = {"group7":["UserVisited"],"group4":["FOOTWEAR"],"group6":["WOMEN"],"group1":["13090903"]};
    var pixelParams = {"col":"","sugProducts":"","cat":"","px":"6591cbc3bde6a0","prodID":"","brand":"","group":""};
    var gdprParams = "";
